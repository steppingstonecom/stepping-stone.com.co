...
<div class="site-main">
    ...
    <!--features-section-->
    <section
        class="cmt-row features-section cmt-bgcolor-grey bg-img1 cmt-bg cmt-bgimage-yes cmt-bg-pattern clearfix">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="section-title style2">
                        <div class="title-header">
                            <h5>who we are</h5>
                            <h2 class="title">Immigration and citizenship<strong> choose your country!</strong>
                            </h2>
                        </div>
                        <div class="title-desc">
                            <p>We are an expert visa consultant focusing on providing quick services to all your
                                travelling needs. Be it a visa, travel insurance, flight ticketing, we cover it
                                all.</p>
                        </div>
    ...
    <!--cat-section-->
    <section
        class="cmt-row cat-section cmt-bgcolor-darkgrey bg-img2 cmt-bg cmt-bgimage-yes cmt-bg-pattern clearfix">
        <div class="cmt-row-wrapper-bg-layer cmt-bg-layer"></div>
        <div class="container">
            <!-- row -->
            <div class="row">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box style1 icon-align-top-content bor_rad_5">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>People who want to invest in or about to start businesses abroad.
                                            </p>
                                        </div>
                                        <div class="cmt-di_links">
                                            <a href="#" class="di_link">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box style1 icon-align-top-content bor_rad_5">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>To work refers to manage systems used to ensure that work is done
                                                nicely.</p>
                                        </div>
                                        <div class="cmt-di_links">
                                            <a href="#" class="di_link">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6">
                                ...
                                <div class="featured-icon-box style1 icon-align-top-content bor_rad_5">
                                    ...
                                    <div class="featured-content">
                                        ...
                                        <div class="featured-desc">
                                            <p>For the perception & better career opportunities for the
                                                students.</p>
                                        </div>
                                        <div class="cmt-di_links">
                                            <a href="#" class="di_link">
            ...
            <div class="row">
                <div class="col-xl-6 col-xs-12">
                    <div class="pt-15 res-991-pt-0">
                        ...
                        <p>Lorem Ipsum is simply dummy text of the printing ypesetting industry.Professor at
                            Hampden-Sydney been tndustry dard dummy text ever since the 1500s, when aknown
                            contary tonter.</p>
                        <div class="featuredbox-number">
                            <!--featured-icon-box-->
    ...
    <section
        class="cmt-row introduction-section cmt-bgcolor-grey cmt-bg cmt-bgimage-yes bg-img7 cmt-bg-pattern mt_60 res-991-mt-0 clearfix">
        <div class="cmt-row-wrapper-bg-layer cmt-bg-layer"></div>
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-11 mx-auto col-xs-12">
                    <!-- ttm_single_image-wrapper -->
                    <div
                        class="ttm_single_image-wrapper mr-60 pt-60 res-991-pt-0 res-991-mr-0 position-relative">

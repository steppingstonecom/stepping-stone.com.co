							...
							<div class="col-lg-12">
								<div class="d-flex align-items-center justify-content-center flex-row">
									...
									<div class="top_bar_contact_item">
										...
										Visa Consultants, Tupac Amaru 200, USA
									</div>
									...
									<div class="top_bar_social">
										<ul class="social-icons">
											<li class="linkedin-icon"><a href="#"><i class="ti ti-linkedin"></i></a></li>
						...
						<div class="container">
							<div class="row">
								<div class="col-lg-12">
									<!--site-navigation -->
									<div
										class="site-navigation d-flex align-items-center justify-content-between flex-row"
									>
										<!-- site-branding -->
										...
										<div class="d-flex flex-row">
												...
												<ul class="menu">
														...
														<ul class="mega-submenu">
															...
															<li class="mega-menu-item">
																...
																<ul class="mega-submenu">
																	...
																	<li>
																		<a target="_blank" href="header-style-02.html"
																			>Header Style 02</a
																		>
																	</li>
																	<li>
																		<a target="_blank" href="header-style-03.html"
																			>Header Style 03</a
																		>
																	</li>
																</ul>
													...
													<li class="mega-menu-item">
														...
														<ul class="mega-submenu">
															...
															<li>
																<a href="diplomatic-Offical-visa.html"
																	>Diplomatic &amp; Offical Visa</a
																>
															</li>
											...
											<div
												class="header_extra d-flex align-items-center justify-content-end flex-row"
											>
